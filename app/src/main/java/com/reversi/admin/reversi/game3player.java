...
import static com.reversi.admin.reversi.R.layout.activity_game3player;

public class game3player extends AppCompatActivity {
    int i,j,m,n,s,t,u,v,c=0,k=1,done=0,sum=9,black=0,white=0,blue=0,yellow=0;
    int p,r;
    ImageButton b[][] = new ImageButton[10][10];
    Button ok,home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_game3player);

        settextp1 = (TextView)findViewById(R.id.setp31text);
        settextp2 = (TextView)findViewById(R.id.setp32text);
        settextp3 = (TextView)findViewById(R.id.setp33text);
        ...
        b[5][4].setImageResource(R.drawable.black);

        b[3][5].setImageResource(R.drawable.blue);
        b[4][5].setImageResource(R.drawable.black);
        b[5][5].setImageResource(R.drawable.white);
        ...
        try
        {
            for(i=0;i<9;i++)
            {
                ...
                for(j=0;j<9;j++)
                {
                    ...
                    TextView myText4 = (TextView) findViewById(R.id.setp31text );
    ...
    private void gamefinish(String strwin) {
        ...
        AlertDialog.Builder builder1 = builder.setMessage(strwin+" You Want to Restart Game?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(game3player.this,choisemode.class);
    ...
    void goHome()
    {
        ...
        AlertDialog.Builder builder1 = builder.setMessage("Are You Sure You Want to Exit?")
                ...
                .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(game3player.this,MainActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        finish();
    ...
    public void blink(int var){
        TextView myText1 = (TextView) findViewById(R.id.setp31text);
        TextView myText2 = (TextView) findViewById(R.id.setp32text);
        TextView myText3 = (TextView) findViewById(R.id.setp33text);
        if(var==1) {
